...
<html>
	<head>
		...
		<script type="text/javascript">
			function login(){
				$.post("/web/admin.php/Login/login",{
					"uid":$("#uid").val(),
					"pwd":$("#pwd").val()
				},function(data){
					if(data.status == 1){
						window.location.href = "/web/admin.php/Login/home";
	...
	<body style="background: url(/web/Public/img/login_bg.jpg) center center no-repeat;">
		<div>
