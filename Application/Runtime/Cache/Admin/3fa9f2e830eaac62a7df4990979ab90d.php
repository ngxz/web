	      ...
	      <div class="container-fluid">
	        ...
	        <div id="navbar" class="navbar-collapse collapse">
	          <ul class="nav navbar-nav navbar-right">
	          	<li><a onclick="javascript:openifram('Admin/Login/adminMessage')">当前帐号：<?php echo (session('uid')); ?></a></li>
	            <li><a href="#">登录时间:<?php echo (session('time')); ?></a></li>
	            <li><a href="#">登录地区：<?php echo (session('local')); ?></a></li>
	            <li><a href="/web/Admin/Login/logout">安全退出</a></li>
	          </ul>
	        </div>
	      </div>
	    </nav>
	    <div class="container-fluid">
	      	<div class="row">
		        ...
		        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		        	<!--访问默认的统计方法-->
		          	<iframe id="iframe" name="iframe" src="/web/Admin/Admin/tongji">
