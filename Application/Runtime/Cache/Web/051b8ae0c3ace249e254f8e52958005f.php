	...
	<body>
		...
		<div class="navBoxbg">
			<div class="navBox container">
				...
				<div class="nav floatr">
					<ul>
						<li><a href="/">首页</a></li>
						<li class="navActive"><a href="/New/news.html">站内新闻</a></li>
		...
		<div class="newsBoxbg">
			<div class="newsBox container">
				<!--面包屑-->
				<div class="bread">当前位置：<a href="/New/news.html"><?php echo ($channel["name"]); ?></a>-站内新闻列表</div>
				<ul class="listUl">
					<?php if(is_array($data["news"])): $i = 0; $__LIST__ = $data["news"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$news): $mod = ($i % 2 );++$i;?><li class="listLi">
							<div class="listTitle"><a href="/detail/article/channelid/1/id/<?php echo ($news["id"]); ?>"><?php echo ($news["title"]); ?></a></div>
