	...
	<body>
			...
			<div class="navBox container">
				...
				<div class="nav floatr">
					<ul>
						...
						<li class="navActive"><a href="/Php/php.html">PHP学习</a></li>
		...
		<div class="phpBoxbg">
			<div class="phpBox container">
				<!--面包屑-->
				<div class="bread">当前位置：<a href="/Php/php.html"><?php echo ($channel["name"]); ?></a>-PHP文章列表</div>
				<ul class="listUl">
					<?php if(is_array($data["php"])): $i = 0; $__LIST__ = $data["php"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$php): $mod = ($i % 2 );++$i;?><li class="listLi">
							<div class="listTitle"><a href="/detail/article/channelid/3/id/<?php echo ($php["id"]); ?>"><?php echo ($php["title"]); ?></a></div>
